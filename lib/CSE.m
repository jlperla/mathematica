...
Modification: Eric Cousineau (eacousineau@gmail.com)
	...
	Minor modifications from Jesse Perla
*)
BeginPackage["CSE`"];

ExtractCommonSubexpressions::usage = "Optimize expression by finding repeated subexpressions and extracting them into a set of rules.
...
ExtractCommonSubexpressions[expr_]:=
renumberVariables[
	foldOneUseVariables[
		replaceRepeats[
			Together[expr]
